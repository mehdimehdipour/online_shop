    ...
    <nav>
        <ul>
            <li style="width: 20px; margin-left: 10px;">
                <a href="#" class="reg">
                    <div style="width:40px; border-radius:20px; height:30px; padding-right: 7.5px; background-color: #F3D67E;">
                        <img id="menu" class="menu" src="icons/menu.svg" alt=""></div>
                </a>
                <ul class="menu-bar" id="menu-bar">
                    ...
                    <!-- Sub-menu 3 -->
                    <li><a href="login.php">ثبت نام / ورود</a></li>
                    <!-- Sub-menu 4 -->
                    <li><a href="#">درباره ما</a></li>
                    <!-- Sub-menu 5 with nested categories -->
                    <li>
                        <a href="#" class="dropdown">دسته بندی</a> <img id="cate-ic" src="icons/dropdown.svg" alt=""
                                                                        style="width: 30px; margin-right: 60px;">
