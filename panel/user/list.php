    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tr>
                    <td><a class="title" href="#"> <?php echo $user->username; ?></a></td>
                    <td><a class="title" href="#"> <?php echo $user->email; ?></a></td>
                    <td><a class="title" href="#"> <?php
                        if ($user->role=='admin'){echo "مدیر کل";} else {echo "نویسنده";}
                    ?></a></td>

                    <td><a href="dashbord.php?page=edit_user&id=<?php echo $user->id; ?>" class="btn btn-primary btn-xs">
                    ...
                    <td><a href="dashbord.php?page=delete_user&id=<?php echo $user->id; ?>" class="btn btn-danger btn-xs">
