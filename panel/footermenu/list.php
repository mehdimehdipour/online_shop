    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                $footermneu=list_footermenu();
                foreach ($footermneu as $fm): ?>
                <tr>
                    <td><a class="title" href="#"> <?php echo $fm->title; ?></a></td>
                    <td><a class="title" href="#"> <?php echo $fm->link; ?></a></td>

                    <td><a href="dashbord.php?page=edit_footermenu&id=<?php echo $fm->id; ?>" class="btn btn-primary btn-xs">
                    ...
                    <td><a href="dashbord.php?page=delete_footermenu&id=<?php echo $fm->id; ?>" class="btn btn-danger btn-xs">
