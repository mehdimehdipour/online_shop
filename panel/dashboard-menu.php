    ...
    <div class="admin-menu">
        <ul>
            <div class="userwel">
                ...
                <p>خوش آمدید <?php session_start(); echo $_SESSION['login'];?></p>
            </div>
            ...
            <ul class="sub-category">
                <li><a href="dashboard.php?page=list-category">همه دسته ها</a></li>
                <li><a href="dashboard.php?page=add-category">افزودن دسته</a></li>
            </ul>
