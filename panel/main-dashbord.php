...
<!--            <p style="font-size: 16px; padding:0 20px; color:#333"> --><?php
...
//                ?><!-- </p>-->
    ...
    <div class="col-lg-4">
        <div class="ws-comment panel-prod-ws">
            <svg class="bi bi-file-richtext" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
//                    count_post();
    ...
    <div class="col-lg-4">
        <div class="ws-comment panel-ticket-ws">
            <svg class="bi bi-chat-dots-fill" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
