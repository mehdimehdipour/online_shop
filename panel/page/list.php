    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tr>
                    <td><a class="title" href="#"> <?php echo $page->title; ?></a></td>
                    <td><p class="td-content"><?php echo $page->content; ?></p></td>
                    <td><?php echo "http://localhost/term3/page.php?id=$page->id" ?></td>

                    <td><a href="dashbord.php?page=edit_page&id=<?php echo $page->id; ?>" class="btn btn-primary btn-xs">
                    ...
                    <td><a href="dashbord.php?page=delete_page&id=<?php echo $page->id; ?>" class="btn btn-danger btn-xs">
